        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatConversations_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RestaurantGalleries_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageOccupancy = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    PeakHour = table.Column<TimeSpan>(type: "time", nullable: true),
                    Revenue = table.Column<decimal>(type: "decimal(10,2)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantStatistics", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpecialOffers_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PointsTransactions_LoyaltyPoints_LoyaltyPointId",
                        column: x => x.LoyaltyPointId,
                        principalTable: "LoyaltyPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PointsTransactions_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusChangedFrom = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    StatusChangedTo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationHistories_Users_ChangedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodQuality = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointsTransactions_LoyaltyPointId",
                table: "PointsTransactions",
                column: "LoyaltyPointId");

            migrationBuilder.CreateIndex(
                name: "IX_PointsTransactions_ReservationId",
                table: "PointsTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationHistories_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecialOffers_RestaurantId",
                table: "SpecialOffers",
                column: "RestaurantId");
